...
Summary granularity (set at ingest time via LOCOMO_CHUNK_TURNS):
...
Usage:
    python locomo_gold_recall_metrics.py --run locomo-n8            # auto-detect N
    python locomo_gold_recall_metrics.py --run rerank-v1-cache-top16 --chunk-turns 0
    python locomo_gold_recall_metrics.py --run /abs/path --chunk-turns 8 --per-category
"""
...
def main() -> None:
    ...
    print(f"Gold summary 返回率   {pct(gold_hit, gold_total)}")
