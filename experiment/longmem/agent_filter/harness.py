...
from experiment.longmem.agent_filter.corpus import Corpus, load_corpus
from experiment.longmem.agent_filter.prompts import (
    ABSTENTION_HINT,
    CATEGORY_HINTS,
    GAP_HINT_TEMPLATE,
    SUFFICIENCY_SYSTEM,
...
def _vector_search(
    ...
    *,
    ...
    from experiment.longmem.agent_filter.gap_vector import vector_gap_candidates
    ...
    *,
    ...
    try:
        ...
        if p.get("grep_agent_use_skills", False):
            from experiment.longmem.agent_filter.skills import select_skills
