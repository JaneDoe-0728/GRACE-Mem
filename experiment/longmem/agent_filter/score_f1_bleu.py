...
用法:
    python experiment/longmem/agent_filter/score_f1_bleu.py longmem adjn3-lm20b-r1
    python experiment/longmem/agent_filter/score_f1_bleu.py locomo adjn3-lc120b-r1
