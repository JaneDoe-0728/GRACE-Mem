...
from KG.llm.prompts.dynamic_prompting import DYNAMIC_PLANNING_SYSTEM, DYNAMIC_PLANNING_USER
from KG.llm.prompts.hyde_prompting import HYDE_SYSTEM, HYDE_USER
from KG.utils.common import KeywordExtractionResult
from KG.utils.logger_config import _StepTimer, make_module_jlog, setup_logger
...
from KG.pipeline.retrieval_steps import (
...
from KG.pipeline.retrieval_steps.summary_scoring import ScoringWeights
from KG.pipeline.retrieval_steps.narrowing import NarrowingModule
from KG.pipeline.retrieval_steps.temporal import date_within_coarse_range

_jlog = make_module_jlog(name="KG.Retriever", filename="kg_retriever.jsonl")
_trace_jlog = make_module_jlog(name="KG.Retriever.Trace", filename="kg_retrieval_trace.jsonl")
...
class Retriever:
    ...
    def _adaptive_research(
        ...
        *,
        ...
        """
        from KG.pipeline.retrieval_steps.adaptive import (
            compute_confidence,
            rewrite_query,
