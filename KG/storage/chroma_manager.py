...
from KG.storage.chroma_vdb import EntitiesVDB, RelationshipsVDB, SummariesVDB
from KG.storage.bm25 import EntitiesBM25
...
def _resolve_art_dir() -> Path:
    ...
    working dirs (see KG.storage.paths.resolve_artifacts_dir)."""
