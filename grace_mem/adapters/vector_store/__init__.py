...
if TYPE_CHECKING:
    from grace_mem.adapters.vector_store.chroma_manager import ARTIFACTS_DIR, MGR, VDBManager
...
def __getattr__(name: str) -> Any:
    ...
    if name in {"ARTIFACTS_DIR", "MGR", "VDBManager"}:
        ...
        return exports[name]
    raise AttributeError(f"module 'grace_mem.adapters.vector_store' has no attribute {name!r}")
