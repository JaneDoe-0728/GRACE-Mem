...
if TYPE_CHECKING:
    from grace_mem.services.dense_index.chroma_manager import ARTIFACTS_DIR, MGR, VDBManager
...
def __getattr__(name: str) -> Any:
    ...
    if name in {"ARTIFACTS_DIR", "MGR", "VDBManager"}:
        ...
        return exports[name]
    raise AttributeError(f"module 'grace_mem.services.dense_index' has no attribute {name!r}")
