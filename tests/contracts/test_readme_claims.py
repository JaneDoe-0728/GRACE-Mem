...
DOCUMENTED_PATHS = [
    ...
    "grace_mem/data_model/relationships.py",
    ...
    "experiment/benchmarking/evaluation/judge.py",
    "experiment/benchmarking/evaluation/oracle.py",
    "experiment/benchmarking/evaluation/score.py",
    "experiment/longmem/pipeline/watchdog.py",
    "experiment/locomo/pipeline/runner.py",
    "experiment/benchmarking/post_retrieval/longmem.py",
    "experiment/benchmarking/agent_filter.py",
    "experiment/benchmarking/post_retrieval/locomo.py",
...
DOCUMENTED_FUNCTIONS = [
    ...
    ("grace_mem/data_model/relationships.py", ["Relationship", "canonical_rel_id"]),
