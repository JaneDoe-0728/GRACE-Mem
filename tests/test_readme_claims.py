...
def test_automated_tests_are_publishable_but_manual_probes_stay_ignored():
    ...
    assert automated.returncode == 1, "automated tests must be available in public clones"
